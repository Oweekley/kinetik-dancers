...
export default function ThankYouPage() {
  return (
    <main className="min-h-screen bg-[var(--kinetik-lime)] px-5 py-20 text-[var(--kinetik-ink)]">
      <section className="mx-auto max-w-3xl rounded-lg bg-white p-8 shadow-[8px_8px_0_#ff1493]">
        ...
        <p className="mt-5 text-lg leading-8 text-neutral-800">
          Bydd Kinetik Dancers yn cysylltu gyda manylion y wers nesaf.
        </p>
        <p className="mt-4 text-lg leading-8 text-neutral-800">
          Your message has been sent. Kinetik Dancers will reply with the next
          class details.
        </p>
        <a
          href="/"
